...
To use a mapping sameness identifier as IRI, the generated string is appended to URI namespace string `mapping:`.

::: {.callout-warning}
The URI prefix `mapping:` has not been registered at IANA yet, so this may change.
:::
...
::: {.callout-tip title="Note"}
The script assumes an additional method `String.codePointCompare` to compare strings by Unicode Code Point. 
See [this TC39 proposal](http://tc39.es/proposal-compare-strings-by-codepoint/) for an implementation.
:::
