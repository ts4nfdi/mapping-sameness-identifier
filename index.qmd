...
- [`sssom-pydantic`](https://github.com/cthoyt/sssom-pydantic) is an implementation of SSSOM in Python that contains an implementation the Mapping Sameness Identifier (see [usage](https://sssom-pydantic.readthedocs.io/en/latest/api/sssom_pydantic.api.hash_triple.html))
